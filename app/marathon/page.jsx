...
// ── Inline Supabase helpers (no external lib dependency) ──────────────────────
...
const SCHEDULE=[
  ...
  {d:"Thu 24 Apr",type:"shakeout",src:"runna",loc:"St James's Park → ExCeL London",label:"🏃 Race Pace Fartlek • 8km + Expo + Birthday Gift",detail:"2km warm up → 2km @ 5:00/km → 1km easy → 2km @ 5:00/km → 1km cool down\n\n🏁 EXPO (after run): ExCeL London, Custom House (Elizabeth Line). Thu 10am–8pm = quietest day. Bring QR code + passport. In/out 30 min.\n\n🎁 GIFT (after Expo): LEGO Store Leicester Sq (world's largest) or Harry Potter Shop Platform 9¾ at King's Cross."},
  {d:"Fri 25 Apr",type:"birthday",src:"travel",loc:"LHR T2 → Park Plaza Westminster",label:"🎂 Ayaansh's 10th! Fetch Family — T2 (SQ 322 lands 5:55am)",detail:"Leave Park Plaza by 6:30am. Family out by ~7:30am.\n\n⏰ BIRTHDAY DAY (keep your steps <6,000!):\n7:30am — 🎈 Reunite at T2! Banner + gift reveal\n10:30am — Gentle walk: Westminster → Big Ben → St James's Park\n12:30pm — 🍱 OKAN (vegetarian Japanese, 4 min walk from hotel)\n2:30pm — Cinema or Borough Market (seated = resting legs)\n4:30pm — Hotel nap — MANDATORY FOR YOU\n6:00pm — 🍝 Ristorante Olivelli (your pasta carb load + Ayaansh's veggie birthday dinner)\n8:00pm — Lay out race kit. Pin bib. Set 3 alarms.\n9:30pm — SLEEP. Non-negotiable."},
  {d:"Fri 25 Apr",type:"rest",src:"coach",loc:"Park Plaza Westminster",label:"🛌 Complete Rest Day — Race Eve",detail:"Walk only. Under 6,000 steps. Taxi everywhere. Zero alcohol.\nCarb-heavy all day (birthday cake = carbs ✅). Bed 9:30pm sharp."},
  {d:"Sat 26 Apr",type:"race",src:"runna",loc:"Greenwich Start → The Mall",label:"🏅 TCS LONDON MARATHON",detail:"TARGET: 3h27–3h35 @ 4:55–5:05/km\nMass start 09:35. Leave Park Plaza 7:30am (FREE TfL with race bib). Bag drop closes 8:45am.\n\n⚡ NUTRITION PLAN:\n6:00am: Oats + banana + honey + coffee (hotel room)\n8:00am: ☕ Gel 100 Caf 100 #1 (100mg) + 1x SaltStick + beetroot shot\n9:20am: Into start pen. Caffeine peaking at 9:35 gun.\nKm 5: 1x SaltStick\nKm 10 (Cutty Sark): 🟠 Gel 160 #1 + 1x SaltStick\nKm 15: 1x SaltStick\nKm 20 (Tower Bridge): 🟠 Gel 160 #2 + ☕ Gel 100 Caf 100 #2 + 1x SaltStick → peaks km 29–30\nKm 25: 1x SaltStick\nKm 30 (Canary Wharf): 🟠 Gel 160 #3 + 1x SaltStick → ☕ CAFFEINE PEAKING\nKm 32: ☕ Gel 100 Caf 100 #3 + 1x SaltStick ⚠️ CRITICAL → peaks km 40–42\nKm 35 (Embankment): 🟠 Gel 160 #4 + 1x SaltStick\nKm 38: Water only. Final SaltStick if needed.\nKm 42.2: THE MALL 🏅 Aditi + Ayaansh + Adidev are waiting.\n\n👨‍👩‍👦 FAMILY: Download TCS App. Best spots: Cutty Sark (km10) · Tower Bridge (km21) · Embankment (km35) · The Mall (finish, 1.5km from hotel). Agree Horse Guards Rd reunion zone letter BEFORE race start — mobile signal unreliable at finish."},
  {d:"Sun 27 Apr",type:"recovery",src:"coach",loc:"Park Plaza Westminster",label:"💆 Post-Marathon Rest",detail:"Hotel bathtub soak / ice bath. Room service. 9–10hrs sleep.\nTart cherry juice. Ibuprofen for inflammation."},
...
const NUTRITION={
  preRace:[
    ...
    {time:"8:00am",what:"Start area (Blackheath)",detail:"☕ Gel 100 Caf 100 #1 (100mg caffeine + 25g carbs) · 1x SaltStick · 🍇 2× Beetroot shots (400–800mg nitrates) · ⏱ Caffeine peaks at 9:35am race start"},
...
const HANDBOOK=[
  {icon:"🏁",title:"Start Times",items:["Elite wheelchair: 08:50","Elite women: 09:05","Mass start: 09:35 (waves to 11:30)","Your start colour/zone is in your bib packet — check it the night before","Be in your pen well before 09:35. Coaches from hotels depart ~07:00","Cut-off: 8 hours from mass start"]},
  {icon:"🎟️",title:"Expo & Bib Collection",items:["ExCeL London E16 1XL — Custom House (Elizabeth Line or DLR)","Wed–Fri: 10am–8pm | Sat: 8:30am–5:30pm","Thu is quietest — go after your morning shakeout run","Bring: confirmation email (QR code) + passport","You receive: bib, 4 safety pins, kit bag","Name printing: £14 (pre-book online)"]},
  {icon:"🚇",title:"Race Day Transport",items:["FREE TfL travel all day with race bib","Road closures from 07:00 — no driving","Bag drop closes 8:45am — leave hotel by 7:30am","DLR to Greenwich or National Rail to Blackheath — busy 6–8:30am, allow extra time"]},
  {icon:"👨‍👩‍👦",title:"Family Spectator Guide",items:["Download TCS London Marathon App — live GPS tracking","Best spots: Cutty Sark (km 10) · Tower Bridge (km 21) · Embankment (km 35) · The Mall finish","Park Plaza Westminster is 1.5km from The Mall finish","Family reunion: Horse Guards Road — alphabetically signposted — AGREE LETTER ZONE BEFORE RACE","⚠️ Mobile signal at finish is unreliable — screenshot meeting plan","BBC One live from 08:30 · Tower Bridge livestream from 10:30"]},
  {icon:"🗺️",title:"Course",items:["Start: Blackheath/Greenwich (Blue/Red/Green triple start, merges after ~3 miles)","Km 10: Cutty Sark — first big crowd surge","Km 21: Tower Bridge — emotional halfway point","Km 29–32: Canary Wharf loop — mentally toughest section","Km 35–40: Embankment — finish direction visible","Km 42.2: The Mall, Houses of Parliament, Buckingham Palace","Flat course: only 119–138m total elevation gain","Pacers: 3:00 through 7:30 available"]},
  {icon:"🎒",title:"Bag Drop & Post-Race",items:["One small kit bag per runner — collected post-race at The Mall","Bag drop closes 8:45am at start","Finisher medal + t-shirt at The Mall","Family reunion at Horse Guards Road (alphabetical zones)","Sensory Calm Space, Parent + Child Space available near finish","Park Plaza is 1.5km from finish — easy walk for family"]},
];
...
export default function App(){
  ...
  useEffect(()=>{
    (async()=>{
      setSync("saving");
      try{const s=await loadState();if(s){if(s.cats)setCats(s.cats);if(s.chk)setChk(s.chk);}setSync("saved");setTimeout(()=>setSync("idle"),1500);}catch(_){setSync("error");}
    })();
  },[]);
        ...
        <div style={{maxWidth:740,margin:"0 auto"}}>
          <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start"}}>
            <div>
              ...
              <div style={{fontSize:9,fontFamily:"monospace",color:"#3e3660",marginTop:2}}>SIN→LAS→LHR · Park Plaza · 🏅 26 APR 09:35 · 🎂 Ayaansh 10th · EDI→SIN</div>
            </div>

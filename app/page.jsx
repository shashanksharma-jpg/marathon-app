...
const APPS = [
  ...
  // { id:"finance", href:"/finance", emoji:"📊", label:"Finance", status:"live" },
  // { id:"travel",  href:"/travel",  emoji:"✈️",  label:"Travel",  status:"live" },
];
...
function getDaysToRace() {
  const race = new Date("2026-04-26T09:35:00+01:00");
  const now = new Date();
  ...
  return (
    <div style={{
      ...
      <div style={{ display:"flex", alignItems:"center", justifyContent:"space-between", padding:"16px 24px 0" }}>
        <span style={{ fontSize:11, fontFamily:"monospace", color:"#3e3660", letterSpacing:"0.2em" }}>
          SHASHANK.APP
        </span>
        <div style={{
          ...
          fontSize: 13, fontWeight: "bold", color: "#07060e",
        }}>S</div>
      </div>

      {/* Greeting */}
      <div style={{ padding: "28px 24px 0" }}>
        <h1 style={{ margin: 0, fontSize: 28, fontWeight: "normal", color: "#f0ebe2", lineHeight: 1.2 }}>
          {mounted ? getGreeting() : "Welcome"}
        </h1>
        <p style={{ margin: "6px 0 0", fontSize: 13, color: "#4a4260", lineHeight: 1.5 }}>
          {today}
          {days > 0 && days < 60 && (
            <span style={{
              display: "inline-block", marginLeft: 10,
              background: "rgba(200,164,94,0.15)", color: "#c8a45e",
      ...
      <div style={{ padding: "36px 20px 0" }}>
        <div style={{ fontSize: 10, fontFamily: "monospace", color: "#3e3660", letterSpacing: "0.18em", marginBottom: 16, paddingLeft: 4 }}>
          APPS
        </div>
        <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 6 }}>
            ...
            <Link key={app.id} href={app.href} style={{ textDecoration: "none" }}>
              ...
              >
                <div style={{
                  ...
                  display: "flex", alignItems: "center", justifyContent: "center",
                  fontSize: 32,
                  transform: pressed === app.id ? "scale(0.90)" : "scale(1)",
          ...
          <div style={{ display:"flex", flexDirection:"column", alignItems:"center", gap:8, opacity:0.3 }}>
            <div style={{
              width: "100%", aspectRatio: "1",
              borderRadius: 20,
              border: "1.5px dashed #2a2448",
              display: "flex", alignItems: "center", justifyContent: "center",
              fontSize: 24, color: "#2a2448",
            }}>+</div>
      ...
      <div style={{ padding: "24px 20px 0" }}>
        <div style={{ fontSize: 10, fontFamily: "monospace", color: "#3e3660", letterSpacing: "0.18em", marginBottom: 12, paddingLeft: 4 }}>
          QUICK ACCESS
        </div>
        {APPS.map(app => (
          <Link key={app.id} href={app.href} style={{ textDecoration: "none" }}>
            ...
            >
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                ...
                <div style={{ fontSize: 12, color: "#4a4260", marginTop: 1 }}>
                  {app.id === "marathon" ? "Schedule · Nutrition · Race day" : ""}
                </div>
              </div>
      ...
      <div style={{ marginTop: "auto", paddingTop: 40, textAlign: "center" }}>
        <div style={{ fontSize: 9, fontFamily: "monospace", color: "#1e1830", letterSpacing: "0.2em" }}>
          BUILT WITH CLAUDE
        </div>
      </div>
